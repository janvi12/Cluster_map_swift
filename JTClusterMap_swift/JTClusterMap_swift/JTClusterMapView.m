...
#import "JTClusterMapView.h"
#import "JTClusterManager.h"

@interface JTClusterMapView (Private)
- (void) setup;
- (BOOL) mapViewDidZoom;
@end

@implementation JTClusterMapView
...
- (void) mapView:(MKMapView *)mapView regionDidChangeAnimated:(BOOL)animated
{
    ...
    NSArray *add = [JTClusterManager clusterAnnotationsForMapView:self forAnnotations:annotationsCopy blocks:self.blocks minClusterLevel:self.minimumClusterLevel];
...
- (void) addAnnotations:(NSArray *)annotations
{
    ...
    NSArray *add = [JTClusterManager clusterAnnotationsForMapView:self forAnnotations:annotations blocks:self.blocks minClusterLevel:self.minimumClusterLevel];
